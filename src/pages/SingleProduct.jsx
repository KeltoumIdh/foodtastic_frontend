...
import { QuantityInput, SectionTitle, SingleProductRating, SingleProductReviews, } from "../components";
...
export const singleProductLoader = async ({ params }) => {
    ...
    return { productData: response?.data?.product ?? [] };
};
...
const SingleProduct = () => {
    ...
    const addToWishlistHandler = async (product) => {
        try {
            ...
            const postResponse = await axios.put(`/api/user/${localStorage.getItem("id")}`, userObj);
                ...
                <div className="single-product-content flex flex-col gap-y-5 max-lg:mt-2">
                    ...
                    <div>
                        ...
                        <div className="flex items-center gap-1">
                            <QuantityInput quantity={quantity} setQuantity={setQuantity} max={productData?.quantity_available} />
                        </div>
                    </div>
