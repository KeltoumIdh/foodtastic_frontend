    ...
    <footer className="footer footer-center p-10 bg-base-200 text-base-content gap-4 rounded mt-10 max-md:px-0">
      ...
      <nav>
        <div className="grid grid-flow-col gap-4">
          ...
          <Link
            to={`https://www.instagram.com/foodtastic.ynov/?igsh=em9rcjJwdnNpZHhj`}
            target="_blank"
          >
            <FaSquareInstagram className="text-6xl max-sm:text-4xl text-accent-content cursor-pointer" />
          </Link>
